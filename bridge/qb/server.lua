...
function RegisterCommand(command, text, args, level, cb)
...
function AddInventory(source, item, count)
    local Player = QBCore.Functions.GetPlayer(source)
    Player.Functions.AddItem(item, count, false)
